...
public class Request {
	...
	private static final String dialogAPI = "https://api.recast.ai/build/v1/dialog";
	...
	public String doDialogRequest(String myText,String language, String memory) {
		URL obj;
		try {
			obj = new URL(dialogAPI);
			//myText = "{"+myText + ", { \"conversationId\":\""+conversationId+"\"}}";
			String recastJson = this.doDialogApiRequest(myText, this.token, this.language, obj);
			return recastJson;
		} catch (MalformedURLException e) {
			throw new RecastException("Invalid URL", e);
		}
...
//            obj = new URL(recastAPI);
	...
	public String doDialogApiRequest(String text, String token, String language, URL obj) throws RecastException {
//      URL					obj;
      HttpsURLConnection	con;
      OutputStream		os;
      int					responseCode;
